 ...
 */
class CloneGeometryBuilderTest extends TestCase
{
    ...
    public function cloneGeometryWithTwoFactory(array $data) {
        $factory1 = $this->getMockForAbstractClass( AbstractGeometryFactory::class);
        $factory2 = $this->getMockForAbstractClass(AbstractGeometryFactory::class, [['srid' => 3857]]);
