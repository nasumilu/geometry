...
class PointTest extends AbstractGeometryTest
{
     ...
     */
    public function testHasOrdinate(array $factoryOptions)
    {
     ...
     * @param array $factoryOptions
     */
    public function testGetX(array $factoryOptions)
    {
        $factory = $this->getMockForAbstractClass(AbstractGeometryFactory::class, [$factoryOptions]);
     ...
     * @param array $factoryOptions
     */
    public function testSetX(array $factoryOptions)
    {
        $factory = $this->getMockForAbstractClass(AbstractGeometryFactory::class, [$factoryOptions]);
     ...
     * @param array $factoryOptions
     */
    public function testGetY(array $factoryOptions)
    {
        $factory = $this->getMockForAbstractClass(AbstractGeometryFactory::class, [$factoryOptions]);
     ...
     * @param array $factoryOptions
     */
    public function testSetY(array $factoryOptions)
    {
        $factory = $this->getMockForAbstractClass(AbstractGeometryFactory::class, [$factoryOptions]);
        $point = new Point($factory);
     ...
     * @param array $factoryOptions
     */
    public function testGetZ(array $factoryOptions)
    {
        $factory = $this->getMockForAbstractClass(AbstractGeometryFactory::class, [$factoryOptions]);
     ...
     * @param array $factoryOptions
     */
    public function testSetZ(array $factoryOptions)
    {
        $factory = $this->getMockForAbstractClass(AbstractGeometryFactory::class, [$factoryOptions]);
        $point = new Point($factory);
        if ($factoryOptions['is_3d'] ?? false) {
     ...
     * @param array $factoryOptions
     */
    public function testGetM(array $factoryOptions)
    {
        $factory = $this->getMockForAbstractClass(AbstractGeometryFactory::class, [$factoryOptions]);
     ...
     * @param array $factoryOptions
     */
    public function testSetM(array $factoryOptions)
    {
        $factory = $this->getMockForAbstractClass(AbstractGeometryFactory::class, [$factoryOptions]);
        $point = new Point($factory);
        if ($factoryOptions['is_measured'] ?? false) {
